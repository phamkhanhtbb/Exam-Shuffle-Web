...
class TestWorkerParsing:
    ...
    def test_parse_sqs_body_with_exam_codes(self):
        ...
        job_id, file_key, perm_list, num_variants, answer_map, exam_codes = (
...
class TestServerExamCodes:
    ...
    async def test_submit_job_sends_exam_codes(self):
        ...
        pytest.importorskip(
            "prometheus_fastapi_instrumentator", reason="Server deps needed"
        )
        ...
        # Mock AWS operations
        with (
            patch("services.aws_service.aws.update_job_status"),
